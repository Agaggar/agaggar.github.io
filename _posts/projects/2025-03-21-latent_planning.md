...
project:
  ...
  logo: "/assets/images/projects/latentplanning/shooting_method.mp4"
  tech: "MLPs, PyTorch, Autoencoders"

images:
  - image:
    url: "/assets/images/projects/latentplanning/iLQR.mp4"
    alt: "iLQR control for cartpole balancing"
  - image:
    url: "/assets/images/projects/latentplanning/shooting_method.mp4"
    alt: "Random shooting method, MPC control for cartpole balancing"
---
...
Cons: No linearity
In the video, I employ a random shooting method (simulate 20 trajectories, take the control action that most minimizes the latent difference, then replan).
